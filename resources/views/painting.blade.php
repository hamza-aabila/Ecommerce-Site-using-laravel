		...
		<div class="grids_of_4">
		  <div class="grid1_of_4">
			<div class="content_box"><a href="">
		   	   	 <img src="../storage/{{$paintings->image}}" style="width:150px; height: 200px;">
			   	  </a>
			   	  
			    <h4><a href="details.html">{{$paintings->title}}</a></h4>
			     <p>{{$paintings->excerpt}}</p>
				 <div class="grid_1 simpleCart_shelfItem">
			    
				 <div class="item_add"><span class="item_price"><h6>{{$paintings->price}}$</h6></span></div>
				<div class="item_add"><span class="item_price"><a href="{{ url('cart/addItem') }}/{{ $paintings->id }}">add to cart</a></span></div>
				 </div>
		   	</div>
		</div>
		@endforeach	
